        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="{{ route('home')}}">
                <i class="fa fa-dashboard"></i> <span>Dashboard</span></a> <!--<i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li>
              <a href="{{ route('testhome')}}">
                <i class="fa fa-th"></i> <span>News</span> <small class="label pull-right bg-green">new</small>
              </a>
            </li>
           <!-- <li class="treeview">
              <a href="#">
